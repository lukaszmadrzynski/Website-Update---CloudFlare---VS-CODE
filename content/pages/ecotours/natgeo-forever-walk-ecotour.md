  ...
  - type: FeaturedItemsSection
    ...
    items:
      ...
      - type: FeaturedItem
        ...
        subtitle: ''
        text: >+
          Uncover the mysteries of Tiger Cave, a fascinating local **geological
          wonder**. Explore its intriguing

          rock formations and delve into the legends surrounding this natural
          site,

          adding an element of adventure to your ecotour.
      ...
      - type: FeaturedItem
        ...
        subtitle: ''
        text: >+
          Journey through **charming minority villages** and tranquil hamlets,
          each with its own unique

          character. Observe diverse architectural styles, local traditions, and
          the

          peaceful rhythm of rural life in Yunnan's diverse communities.
      ...
      - type: FeaturedItem
        ...
        text: >+
          ...
          Capture **breathtaking panoramic views** and feel the powerful
          presence of this

          iconic natural wonder, a true highlight of Yunnan.
